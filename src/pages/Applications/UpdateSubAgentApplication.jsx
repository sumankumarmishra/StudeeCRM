...
const UpdateSubAgentApplication = ({ title }) => {
  ...
  useEffect(() => {
    axios
      .get(`https://crm.internationaleducationoffice.co.uk/applications/applicationById/${id}`, config)
      .then((response) => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://crm.internationaleducationoffice.co.uk/programTypes", config)
      .then((response) => {
    ...
    axios
      .get(`https://crm.internationaleducationoffice.co.uk/members/member1/${memberId}`, config)
      .then((response) => {
    ...
    axios
      .get("https://crm.internationaleducationoffice.co.uk/core-settings/qualifications", config)
      .then((response) => {
    ...
    axios
      .get("https://crm.internationaleducationoffice.co.uk/core-settings/english-tests", config)
      .then((response) => {
    ...
    try {
      ...
      if (data.dynamicFields) {
        const dynamicFieldsKeys = Object.keys(data.dynamicFields);
        const responseKeys = allFields.map((field) => field.key);
        const allKeys = [...new Set([...dynamicFieldsKeys, ...responseKeys])];

        const updatedDynamicFields = allKeys.reduce((fields, key) => {
          fields[key] = data.dynamicFields[key] || "";
          return fields;
        }, {});
  ...
  useEffect(() => {
    if (countryLivingIn) {
      ...
      axios
        .get(`https://crm.internationaleducationoffice.co.uk/core-settings/region`, config)
        .then((response) => {
      ...
      axios
        .get(`https://crm.internationaleducationoffice.co.uk/core-settings/last-institution`, config)
        .then((response) => {
  ...
  useEffect(() => {
    if (universityId) {
      ...
      axios
        .get(`https://crm.internationaleducationoffice.co.uk/campus/${universityId}`, config)
        .then((response) => {
        ...
        <div className="container-fluid">
          <div className="row me-3 mt-3 ms-2">
            {page_no === 0 ? (
              ...
              <div className="col-md-7 box7 p-3">
                <div className="heading-box">
                  <DocumentModel selectedRow={data} newApp={false} />
                </div>
              </div>
            ) : page_no === 3 ? (
              <div className="col-md-7 box7 p-3">
          ...
          <div className="right">
            ...
            <Form onSubmit={handleSubmit}>
              <div>
                ...
                {notesPermission &&
                (notesPermission.update || notesPermission.read) ? (
                  notesPermission.update ? (
                    <Form.Group className="mt-3">
                      <Form.Label className="fw-bold mt-2">Notes</Form.Label>
                      <Form.Control
                        as="textarea"
...
export default UpdateSubAgentApplication;
