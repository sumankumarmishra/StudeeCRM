...
const NewDegree = ({
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`https://crm.internationaleducationoffice.co.uk/degree/${id}`, formData, config)
      .then((response) => {
        setName("");
        SetAbroad("");
        SetProgramStructure("");
   ...
   <div style={{height: "650px", overflow: "hidden", overflowY: "scroll"}}>
     <Form onSubmit={handleSubmit}>
      ...
      <Form.Label className="label-form">
        Faculty Banner Image (PNG/JPEG/JPG)
      </Form.Label>
      <Form.Control
        type="file"
        id="myFile"
