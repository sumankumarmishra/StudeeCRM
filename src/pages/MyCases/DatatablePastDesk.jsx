...
const DatatablePastDesk = () => {
  ...
  useEffect(async () => {
    try {
      const response = await axios.get(
        `https://crm.internationaleducationoffice.co.uk/applications/past-desk/${id}`,
        config
      );
  ...
  useEffect(() => {
    axios
      .get(
        `https://crm.internationaleducationoffice.co.uk/applications/past-desk/number/${page_number}/${id}`,
        config
      )
      .then((response) => {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        setTotalCount(response.data.past_desk);
        console.log(response.data.past_desk);
        setTotalFilteredCount(response.data.past_desk);
      })
      .catch((error) => {
        console.log(error);
      });
  ...
  return (
    ...
    >
      <h4 className="fw-bold">Past Desk Cases ({totalCount})</h4>{" "}
      {/* {filter ? (
        <Button
          variant="danger"
...
export default DatatablePastDesk;
